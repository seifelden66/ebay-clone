...
const Product: React.FC<ProductProps> = ({product}) => {
  return (
    ...
    <Link 
      ...
      className='max-w-[200px] p-1.5 border border-gray-50 hover:border-gray-200 
      hover:shadow-xl bg-gray-100 rounded mx-auto'
    >
      { product?.url && <img alt="image" className="rounded cursor-pointer" src={product.url+'/190'} /> }
